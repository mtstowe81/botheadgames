...
config =
{
    debug =
    {
        ...
        assertDialogs = false, -- Display dialog boxes when asserting - if false, asserts are console messages
        typeChecking = false,  -- Turn on dbg.xxx functions that Quick uses internally to check types in some engine functions
